...
Phylo.Util.CONSTANT.copyPrototype(Phylo.Util.Exceptions,Error);
...
Phylo.Util.CONSTANT.copyPrototype(Phylo.Util.Exceptions.Generic,Phylo.Util.Exceptions);
...
Phylo.Util.CONSTANT.copyPrototype(Phylo.Util.Exceptions.System,Phylo.Util.Exceptions.Generic);
...
Phylo.Util.CONSTANT.copyPrototype(Phylo.Util.Exceptions.BadFormat,Phylo.Util.Exceptions.System);
...
Phylo.Util.CONSTANT.copyPrototype(Phylo.Util.Exceptions.API,Phylo.Util.Exceptions.Generic);
...
Phylo.Util.CONSTANT.copyPrototype(Phylo.Util.Exceptions.UnknownMethod,Phylo.Util.Exceptions.API);
...
Phylo.Util.CONSTANT.copyPrototype(Phylo.Util.Exceptions.NotImplemented,Phylo.Util.Exceptions.API);
...
Phylo.Util.CONSTANT.copyPrototype(Phylo.Util.Exceptions.Deprecated,Phylo.Util.Exceptions.API);   
...
Phylo.Util.CONSTANT.copyPrototype(Phylo.Util.Exceptions.BadArgs,Phylo.Util.Exceptions.Generic);
...
Phylo.Util.CONSTANT.copyPrototype(Phylo.Util.Exceptions.BadString,Phylo.Util.Exceptions.BadArgs);
...
Phylo.Util.CONSTANT.copyPrototype(Phylo.Util.Exceptions.OddHash,Phylo.Util.Exceptions.BadArgs);
...
Phylo.Util.CONSTANT.copyPrototype(Phylo.Util.Exceptions.ObjectMismatch,Phylo.Util.Exceptions.BadArgs);
...
Phylo.Util.CONSTANT.copyPrototypeMI(Phylo.Util.Exceptions.InvalidData,[Phylo.Util.Exceptions.BadString,Phylo.Util.Exceptions.BadFormat]);
...
Phylo.Util.CONSTANT.copyPrototype(Phylo.Util.Exceptions.OutOfBounds,Phylo.Util.Exceptions.BadArgs);
...
Phylo.Util.CONSTANT.copyPrototype(Phylo.Util.Exceptions.BadNumber,Phylo.Util.Exceptions.Generic);
...
Phylo.Util.CONSTANT.copyPrototype(Phylo.Util.Exceptions.FileError,Phylo.Util.Exceptions.System);
...
Phylo.Util.CONSTANT.copyPrototypeMI(Phylo.Util.Exceptions.ExtensionError,[Phylo.Util.Exceptions.System,Phylo.Util.Exceptions.BadFormat]);
})();
