...
-->
    ...
    <xsl:template match="log">
      <rss version="2.0">
           <channel>
                <title>SVN: nexml</title> <!-- put your repository name here -->
                <link>http://nexml-dev.nescent.org/</link> <!-- put your project homepage here -->
                <description>svn commit log</description>
                <language>en-us</language>
                <copyright>2007, the nexml initiative</copyright> <!-- put your company here -->
    ...
    <xsl:template match="logentry">
      <item>
           ...
           <author><xsl:value-of select="author" />@codingmonkeys.de</author> <!-- put your domain here -->
