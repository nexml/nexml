...
Phylo.Util.XMLWritable.prototype.set_attributes = function(attrs) {
	if (attrs==null) attrs = {};
...
Phylo.Util.XMLWritable.prototype.set_xml_id = function(xml_id) {
	this.xml_id = xml_id;	
	return this;
};

Phylo.Util.XMLWritable.prototype.get_tag = function() {
	return this.tag;
};

Phylo.Util.XMLWritable.prototype.get_xml_tag = function(close_me) {
...
Phylo.Util.XMLWritable.prototype.get_root_open_tag = function () {
...
Phylo.Util.XMLWritable.prototype.get_root_close_tag = function () {
	return '</nex:nexml>';
}

Phylo.Util.XMLWritable.prototype.get_attributes = function () {
	...
	if ( this.get_taxa != null ) { // duck-typing!
		...
		if ( taxa != null ) {
			...
			throw new Phylo.Util.Exceptions.ObjectMismatch( this + "can link to a taxa element, but doesn't");
		}
	}
	if ( this.get_taxon != null ) { // duck-typing!
		...
		if ( taxon != null ) {
			...
			Phylo.Util.Logger.info("No linked taxon found");
		}
	}
	return attrs;
}

Phylo.Util.XMLWritable.prototype.get_xml_id = function () {
	if ( this.xml_id != null ) {
		return this.xml_id;
	}
	else {
...
Phylo.Util.XMLWritable.prototype.to_xml = function () {
	var xml = '';
